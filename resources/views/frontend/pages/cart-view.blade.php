            ...
            <div class="container">
                <div class="fp__breadcrumb_text">
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:0;">Cart View</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fp__pro_tk">
                                                <h6 class="product_cart_total">
                                                    {{ currencyPosition(productTotalPrice($product->rowId)) }}</h6>
                                            </td>

                                            <td class="fp__pro_icon">
                                                <a href="#" data-id="{{ $product->rowId }}"
            ...
            $('.increase').on('click', function() {
                ...
                cartQtyUpdate(rowId, inputField.val(), function(response) {
                    ...
                    inputField.closest("tr")
                        ...
                        .text('{{ currencyPosition(':productTotal') }}'.replace(':productTotal',
                            productTotal));
            ...
            $('.decrease').on('click', function() {
                ...
                if (inputField.val() > 1) {
                    ...
                    cartQtyUpdate(rowId, inputField.val(), function(response) {
                        ...
                        inputField.closest("tr")
                            .find(".product_cart_total")
                            .text('{{ currencyPosition(':productTotal') }}'.replace(
                                ':productTotal',
                                productTotal));
