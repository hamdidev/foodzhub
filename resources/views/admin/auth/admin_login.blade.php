          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="mb-3" method="POST" action="{{ route('login') }}">
                            @csrf
                            <div class="mb-3">
                            <label for="input_type" class="form-label">Email or Username</label>
                            <input
                                type="text"
                                class="form-control"
                                id="input_type"
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                />
                                <span class="input-group-text cursor-pointer"><i class="bi bi-eye-slash" id="togglePassword" ></i></span>
                            </div>
                            </div>
                            <div class="mb-3">
