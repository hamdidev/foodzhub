                            ...
                            <form method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="myeditor" class="form-control" id="" name="long_desc" rows="3">{{ old('long_desc') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="seo_desc" class="form-label">SEO Description</label>
                                        <textarea class="form-control" id="seo_desc" name="seo_desc" rows="3">{{ old('seo_desc') }}</textarea>
                                    </div>
                                </div>
